...
``arcedfold`` is a Stata command that creates specific folder structures for ARCED's projects. ``arcedfold`` creates all the folders for a project. This can be used at the very begining of a project, or to archieve files after completing a project.
