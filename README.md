...
``db arcedfold`` opens a dialog box that allows users to run arcedfold, arcedsubfold, and arceddataflow without writing any additional code.
...
#### Current version
:memo: V4: August 2025 - [GitHub repo](https://github.com/ARCED-Foundation/arcedfold/tree/V4)
